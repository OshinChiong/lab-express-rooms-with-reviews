...
router.get("/create", isLoggedIn, function (req, res, next) {
  res.render("room/create-rooms");
});

router.post("/create", isLoggedIn, function (req, res, next) {
  if (!req.body.name || !req.body.description) {
    res.render("room/create-rooms", { message: "please fill out all fields" });
  }
  Room.create({
    name: req.body.name,
...
router.get("/all", (req, res) => {
  Room.find()
    ...
    .then((allRooms) => {
      ...
      res.render("room/all", { allRooms: allRooms });
    })
    .catch((err) => {
...
//     .catch((error) => {
//       console.log("Failed");
//       resource.render("room/create-rooms", {
//         message: "something went wrong creating a room",
//       });
//     });
// });
...
//       })
//       .then((all) => {
//         console.log("All Rooms", all[0].reviews);
//         res.render("room/all", { all: all });
//       })
//       .catch((err) => {
//         console.log("Failed", err.message);
//         res.redirect("/");
...
//     Room.find({ owner: req.session.user._id })
//       .then((allRooms) => {
//         res.render("room/my-rooms", { allRooms: allRooms });
//       })
//       .catch((err) => {
//         console.log("Failed", err.message);
//         res.redirect("/");
...
//     Room.findById(req.params.id)
//       .then((foundRoom) => {
//         res.render("room/edit-room", { foundRoom: foundRoom });
//       })
//       .catch((error) => {
//         console.log("failed", error.message);
//       });
